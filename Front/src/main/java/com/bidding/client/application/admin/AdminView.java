...
import com.bidding.client.widget.ImageAvatarCell;
import com.bidding.client.widget.MyCellTable;
...
public class AdminView extends ViewWithUiHandlers<AdminUiHandlers> implements AdminPresenter.MyView {
    ...
    private void initTable() {
        ...
        ///Нужно починить //TODO спросить у Andrey что нужно починить?
